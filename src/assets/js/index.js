...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Je... vie...", "author": "Luuxis, DracoMC" },
            { "message": "Salut je suis du code.", "author": "Luuxis, DracoMC" },
            { "message": "Linux n'est pas un os, mais un kernel.", "author": "Luuxis, DracoMC" }
        ];
